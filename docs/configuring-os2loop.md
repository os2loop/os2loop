...
Subject: Is used for grouping content related to similar themes (subjects) e.g. "Support" or "Administration".
Tags: Is used as inspirational words for similar content e.g. "Ernæringsindsats" or "Hjælpemidler". As opposed to the other taxonomy terms these can also be defined by end users when submitting questions and/or answers.
